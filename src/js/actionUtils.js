...
const allotmentQuery  = `SELECT APPLICATION_NO,CANDIDATE_NAME,AGGR_MARK,RANK,COMMUNITY,COLLEGE_CODE,BRANCH_CODE,ALLOTTED_CATEGORY,ROUND FROM Allotment where APPLICATION_NO >= '0'`;
